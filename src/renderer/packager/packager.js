...
const setProject = (data, name) => {
  // Switch to file mode
  const fileTypeRadio = document.querySelector(
    ".file-input-option input[type=radio]"
  );
  fileTypeRadio.click();
  ...
  const fileInput = document.querySelector(
    ".file-input-option input[type=file]"
  );
...
const getPackagerHTML = () =>
  ipcRenderer
    .invoke("get-packager-html")
