...
const handleStorageInit = storage => {
    storage.addHelper(new StorageHelper(storage, asset => `sidekick-library-files://library-files/${asset}`));
...
const DesktopHOC = function (WrappedComponent) {
    ...
    const mapDispatchToProps = dispatch => ({
        ...
        onLoadedProject: (loadingState, loadSuccess) => dispatch(onLoadedProject(loadingState, /* canSave */ false, loadSuccess)),
