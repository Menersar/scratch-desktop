...
import SidekickStateManagerHOC from "scratch-gui/src/lib/sidekick-state-manager-hoc.jsx";
import SidekickRestorePointHOC from "scratch-gui/src/lib/sidekick-restore-point-hoc.jsx";
import {
  openLoadingProject,
  closeLoadingProject,
...
const handleStorageInit = (storage) => {
  storage.addHelper(
    new StorageHelper(
      storage,
      (asset) => `sidekick-library-files://library-files/${asset}`
    )
  );
  storage.addHelper(
    new StorageHelper(
      storage,
      (asset) =>
        `https://assets.scratch.mit.edu/internalapi/asset/${asset}/get/`
    )
  );
};
...
const openSourceCode = () => {
  // !!! CHANGE !!!
  // window.open('https://github.com/Mixality/Sidekick');
  // window.open('https://github.com/Mixality');
  // window.open('https://github.com/Menersar');
...
darkModeMedia.onchange = () =>
  document.body.setAttribute("theme", darkModeMedia.matches ? "dark" : "light");
darkModeMedia.onchange();
...
const DesktopHOC = function (WrappedComponent) {
  ...
  class DesktopComponent extends React.Component {
    constructor(props) {
      ...
      this.handleExportProjectOverIPC =
        this.handleExportProjectOverIPC.bind(this);
      this.handleLoadExtensionOverIPC =
        this.handleLoadExtensionOverIPC.bind(this);
    ...
    render() {
      ...
      return (
        <WrappedComponent
          ...
          onClickNewWindow={[getTranslation("menu.new-window"), openNewWindow]}
          onClickAbout={[
            {
