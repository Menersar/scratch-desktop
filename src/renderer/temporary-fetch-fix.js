...
// !!! horrible 'hack'? ???
// !!! CHANGE !!!
// This is horrible. Scratch.fetch disables redirects, but in the desktop app, extensions.mixality.de
...
window.fetch = function fetchWithRedirectFix(url, options) {
  ...
  // if (typeof url === 'string' && (url.startsWith('http://localhost') || url.startsWith('https://menersar.github.io/Sidekick/extensions/')) && options) {
  // !!! NEU
