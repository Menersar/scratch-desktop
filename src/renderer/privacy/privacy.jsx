...
ReactDOM.render((
    ...
    <main>
        ...
        <p>Scratch extensions that require Wi-Fi (such as Translate, Text to Speech, LEGO, micro:bit, etc.) may connect to the Scratch API to implement these features. <a
            href="https://scratch.mit.edu/privacy_policy/"
            target="_blank"
            rel="noreferrer"
        >Refer to the Scratch privacy policy for more information</a>. The Translate extension may instead make requests to a Sidekick API, which may then forward your request to the Scratch API and log the message being translated and the result for caching and performance.</p>
        ...
        <p>If the packaged project uses the Translate extension or is configured to "Connect to cloud variable server", then the project may connect to servers controlled by Sidekick. The project ID and username may be logged. <a href="https://menersar.github.io/Sidekick/privacy.html">Refer to the primary Sidekick privacy policy for more information</a>.</p>
        ...
        <p>Any concerns related to privacy or any other matter should be sent to: <a href="mailto:contact@sidekick.org">contact@sidekick.org</a></p>
    </main>
), require('../app-target'));
