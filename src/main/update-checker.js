...
const getLatestVersions = () => new Promise((resolve, reject) => {
    // !!! CHANGE !!!
    // !!!!!HERE!!!!!
    // const request = net.request('https://mixality.github.io/Sidekick/desktop/version.json');
    const request = net.request('https://menersar.github.io/Sidekick/desktop/version.json');
...
const getUpdateURL = (current, latest) => `https://menersar.github.io/Sidekick/desktop/update_available.html?from=${encodeURIComponent(current)}&to=${encodeURIComponent(latest)}`;
