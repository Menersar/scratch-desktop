...
def get_versions(username, repository):
    with urllib.request.urlopen(
        f"https://api.github.com/repos/{username}/{repository}/releases"
    ) as request:
...
if __name__ == "__main__":
    ...
    download_releases(
        package_name="sidekick-desktop",
        # !!! CHANGE !!!
        # !!! Set 'component' to 'sidekick', 'main' or 'master'? ???
        # username='Mixality',
        username="Menersar",
        repository="sidekick-desktop",
        component="main",
