...
const md5 = (buffer) =>
  crypto.createHash("md5").update(new Uint8Array(buffer)).digest("hex");
...
const downloadAsset = async (asset) => {
  ...
  // const response = await fetch(`https://mixality.github.io/Sidekick/assets/${md5ext}`);
  // const response = await fetch(`https://menersar.github.io/Sidekick/assets/${md5ext}`);
